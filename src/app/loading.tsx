...
const Loading: React.FC = () => {
  ...
  return (
    <div css={loadingContainerStyles}>
      <img src="/assets/images/loadingImage_2.png" alt="air" css={airImageStyles} className="airImage" />
      <img src="/assets/images/loadingImage_1.png" alt="point" css={pointStyles} className="pointImage" />
